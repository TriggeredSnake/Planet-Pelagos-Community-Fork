...
data:extend({
	{
		...
		icon = "__TS_Pelagos_CF__/graphics/thruster/ethanol_thruster.png",
		subgroup = "space-platform",
		order = "f[ethanol-thruster]",
	...
	},
	{
		...
		energy_required = 10,
		results = { { type = "item", name = "ethanol-thruster", amount = 1 } },
	},
	{
		type = "thruster",
		name = "ethanol-thruster",
		...
		collision_mask = {
			layers = { item = true, object = true, train = true, is_lower_object = true, is_object = true },
		},
		selection_box = { { -2, -2.5 }, { 2, 5.5 } },
		tile_buildability_rules = {
			{
				area = { { -1.8, -2.3 }, { 1.8, 2.3 } },
				required_tiles = { layers = { ground_tile = true } },
				colliding_tiles = { layers = { empty_space = true } },
				remove_on_collision = true,
			},
			{
				area = { { -1.8, 2.7 }, { 1.8, 90.3 } },
		...
		--min_performance = { fluid_volume = 0.1, fluid_usage = 0.1, effectivity = 0.025 },
		--max_performance = { fluid_volume = 0.8, fluid_usage = 2, effectivity = 0.01275 },
		...
		--
		min_performance = { fluid_volume = 0.1, fluid_usage = 0.025, effectivity = 0.2 },
		max_performance = { fluid_volume = 0.8, fluid_usage = 0.25, effectivity = 0.1 },
		fuel_fluid_box = {
			filter = "ethanol",
		...
		graphics_set = {
			animation = util.sprite_load("__TS_Pelagos_CF__/graphics/thruster/thruster", {
				animation_speed = 0.5,
				frame_count = 64,
				scale = 0.5,
				shift = { 0, 3 },
		...
		working_sound = {
			...
			sound_accents = {
				{
					sound = {
						variations = sound_variations(
							"__space-age__/sound/entity/platform-thruster/thruster-mechanic-stop",
							5,
							0.5
						),
				...
				},
				{
					sound = {
						variations = sound_variations(
							"__space-age__/sound/entity/platform-thruster/thruster-mechanic-move",
							5,
							0.3
						),
						advanced_volume_control = {
			...
			activate_sound = {
				variations = sound_variations(
					"__space-age__/sound/entity/platform-thruster/thruster-engine-activate",
					3,
					0.3
				),
			},
			deactivate_sound = {
				variations = sound_variations(
					"__space-age__/sound/entity/platform-thruster/thruster-engine-deactivate",
					3,
					0.3
				),
			},

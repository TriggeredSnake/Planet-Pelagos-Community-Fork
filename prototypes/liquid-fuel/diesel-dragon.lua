...
function rocketsilopipes()
	return {
		north = {
			...
			filename = "__TS_Pelagos_CF__/graphics/rocketsilopipes/rocketsilopipe-NN.png",
			priority = "extra-high",
			width = 71,
			--height = 38,
			height = 76,
		...
		east = {
			filename = "__TS_Pelagos_CF__/graphics/rocketsilopipes/rocketsilopipe-E.png",
			priority = "extra-high",
			width = 42,
			height = 76,
		...
		south = {
			filename = "__TS_Pelagos_CF__/graphics/rocketsilopipes/rocketsilopipe-S.png",
			priority = "extra-high",
			width = 88,
			height = 61,
		...
		west = {
			filename = "__TS_Pelagos_CF__/graphics/rocketsilopipes/rocketsilopipe-W.png",
			priority = "extra-high",
			width = 39,
			height = 73,
...
data:extend({
	{
		type = "item",
		name = "diesel-dragon",
		icon = "__TS_Pelagos_CF__/graphics/diesel-dragon/rocket-silo.png",
		subgroup = "space-related",
		order = "a[rocket-silo]",
		inventory_move_sound = item_sounds.mechanical_large_inventory_move,
		pick_sound = item_sounds.mechanical_large_inventory_pickup,
		drop_sound = item_sounds.mechanical_large_inventory_move,
		place_result = "diesel-dragon",
		weight = 10 * tons,
		stack_size = 1,
	},
	{
		...
		energy_usage = "25MW", --energy usage used when crafting the rocket
		lamp_energy_usage = "0kW",
		active_energy_usage = "3990kW",
		rocket_entity = "diesel-rocket-silo-rocket",
		times_to_blink = 3,
		...
		base_day_sprite = {
			filename = "__TS_Pelagos_CF__/graphics/diesel-dragon/06-rocket-silo.png",
			dice_y = 3,
			width = 608,
			height = 596,
		...
		arm_01_back_animation = {
			filename = "__TS_Pelagos_CF__/graphics/diesel-dragon/08-rocket-silo-arms-back.png",
			priority = "medium",
			width = 128,
			height = 150,
			frame_count = 32,
		...
		arm_02_right_animation = {
			filename = "__TS_Pelagos_CF__/graphics/diesel-dragon/08-rocket-silo-arms-right.png",
			priority = "medium",
			width = 182,
			height = 188,
			frame_count = 32,
		...
		arm_03_front_animation = {
			filename = "__TS_Pelagos_CF__/graphics/diesel-dragon/13-rocket-silo-arms-front.png",
			priority = "medium",
			width = 126,
			height = 228,
			frame_count = 32,
		...
		base_front_sprite = {
			filename = "__TS_Pelagos_CF__/graphics/diesel-dragon/14-rocket-silo-front.png",
			width = 580,
			height = 262,
	...
	},
	{
		...
		name = "diesel-rocket-silo-rocket",
		flags = { "not-on-map" },
		hidden = true,
		...
		rocket_sprite = {
			layers = {
				util.sprite_load("__TS_Pelagos_CF__/graphics/diesel-dragon/rocket-static-pod", {
					dice_y = 4,
		...
		rocket_smoke_top1_animation = util.add_shift_offset(
			util.by_pixel(0 - 66, -112 + 28 + 232 + 32 + rocket_shift),
			{
		...
		rocket_smoke_top2_animation = util.add_shift_offset(
			util.by_pixel(0 + 17, -112 + 28 + 265 + 32 + rocket_shift),
			{
				filename = "__base__/graphics/entity/rocket-silo/12-rocket-smoke.png",
				priority = "medium",
				tint = { 0.8, 0.8, 1, 0.8 },
		...
		rocket_smoke_top3_animation = util.add_shift_offset(
			util.by_pixel(0 + 48, -112 + 28 + 252 + 32 + rocket_shift),
			{
				filename = "__base__/graphics/entity/rocket-silo/12-rocket-smoke.png",
				priority = "medium",
				tint = { 0.8, 0.8, 1, 0.8 },
		...
		rocket_smoke_bottom1_animation = util.add_shift_offset(
			util.by_pixel(0 - 69, -112 + 28 + 205 + 32 + rocket_shift),
			{
				filename = "__base__/graphics/entity/rocket-silo/12-rocket-smoke.png",
				priority = "medium",
				tint = { 0.8, 0.8, 1, 0.7 },
		...
		rocket_smoke_bottom2_animation = util.add_shift_offset(
			util.by_pixel(0 + 62, -112 + 28 + 207 + 32 + rocket_shift),
			{
				filename = "__base__/graphics/entity/rocket-silo/12-rocket-smoke.png",
				priority = "medium",
				tint = { 0.8, 0.8, 1, 0.7 },
...
data.raw["rocket-silo"]["diesel-dragon"].launch_to_space_platforms = true
data.raw["rocket-silo"]["diesel-dragon"].to_be_inserted_to_rocket_inventory_size = 20
data.raw["rocket-silo"]["diesel-dragon"].logistic_trash_inventory_size = 20
data.raw["rocket-silo-rocket"]["diesel-rocket-silo-rocket"].inventory_size = 20
data.raw["rocket-silo"]["diesel-dragon"].cargo_station_parameters.prefer_packed_cargo_units = true

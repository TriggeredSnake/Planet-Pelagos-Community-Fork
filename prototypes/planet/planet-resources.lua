...
data:extend({
	...
	},
	{
		...
		stages = {
			sheet = {
				filename = "__TS_Pelagos_CF__/graphics/methane-stain.png",
				priority = "extra-high",
				width = 260,
				height = 220,
				frame_count = 1,
...
data:extend({
	{
		...
		order = "a-e-b",
		category = "resource",
		icon = "__TS_Pelagos_CF__/graphics/titanium/titanium-sludge.png",
	...
	},
	{
		...
		stages = {
			sheet = {
				filename = "__TS_Pelagos_CF__/graphics/titanium/titanium-sludge-stain.png",
				priority = "extra-high",
				width = 260,
				height = 220,
				frame_count = 1,

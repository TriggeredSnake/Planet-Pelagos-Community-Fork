...
data:extend({
	{
		...
		resistances = {
			...
			{ type = "laser", decrease = 15, percent = 100 },
			{ type = "electric", decrease = 15, percent = 100 },
		},
...
data:extend({
	{
		...
		resistances = {
			...
			{ type = "poison", decrease = 15, percent = 30 },
			{ type = "laser", decrease = 15, percent = 100 },
			{ type = "electric", decrease = 15, percent = 100 },
		},
		collision_mask = { layers = { ["is_object"] = true, ["train"] = true }, not_colliding_with_itself = true },
		...
		movement_speed = 0.15,
		distance_per_frame = 0.05,
		absorptions_to_join_attack = { electromagnetic_waves = 10 },
...
data:extend({
	{
		...
		resistances = {
			...
			{ type = "poison", decrease = 15, percent = 50 },
			{ type = "laser", decrease = 15, percent = 100 },
			{ type = "electric", decrease = 15, percent = 100 },
		},
		collision_mask = { layers = { ["is_object"] = true, ["train"] = true }, not_colliding_with_itself = true },
		...
		movement_speed = 0.14,
		distance_per_frame = 0.05,
		absorptions_to_join_attack = { electromagnetic_waves = 20 },
...
data:extend({
	{
		...
		resistances = {
			...
			{ type = "explosion", decrease = 10, percent = 90 },
			{ type = "fire", decrease = 3, percent = 90 },
			{ type = "poison", decrease = 15, percent = 90 },
			{ type = "laser", decrease = 15, percent = 100 },
			{ type = "electric", decrease = 15, percent = 100 },
		},
		collision_mask = { layers = { ["is_object"] = true, ["train"] = true }, not_colliding_with_itself = true },
		...
		movement_speed = 0.10,
		distance_per_frame = 0.05,
		absorptions_to_join_attack = { electromagnetic_waves = 40 },
		dying_explosion = "behemoth-spitter-die",
...
data:extend({
	{
		...
		resistances = {
			...
			{ type = "laser", decrease = 10, percent = 100 },
		...
		result_units = {
			{ "small-copper-biter", { { 0.0, 0.3 }, { 0.5, 0.0 } } },
			{ "medium-copper-biter", { { 0.3, 0.0 }, { 0.6, 0.5 }, { 0.7, 0.1 }, { 0.75, 0.0 } } },
			{ "big-copper-biter", { { 0.6, 0.0 }, { 0.85, 0.4 }, { 0.9, 0.0 } } },
			{ "behemoth-copper-biter", { { 0.8, 0.0 }, { 0.9, 1.0 }, { 0.98, 0.4 } } },
			{ "leviathan-copper-biter", { { 0.9, 0.0 }, { 1.0, 1.0 } } },
		},

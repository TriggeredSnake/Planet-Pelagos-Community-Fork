...
-----------------------------------------------------------------------------------------------------------------------
-- Item icon masks
local barrel_side_mask = "__TS_Pelagos_CF__/graphics/titanium-barreling/barrel-side-mask.png"
local barrel_hoop_top_mask = "__TS_Pelagos_CF__/graphics/titanium-barreling/barrel-hoop-top-mask.png"
-- Recipe icon masks
local barrel_empty_icon = "__TS_Pelagos_CF__/graphics/titanium-barreling/barrel-empty.png"
local barrel_empty_side_mask = "__TS_Pelagos_CF__/graphics/titanium-barreling/barrel-empty-side-mask.png"
local barrel_empty_top_mask = "__TS_Pelagos_CF__/graphics/titanium-barreling/barrel-empty-top-mask.png"

local barrel_fill_icon = "__TS_Pelagos_CF__/graphics/titanium-barreling/barrel-fill.png"
local barrel_fill_side_mask = "__TS_Pelagos_CF__/graphics/titanium-barreling/barrel-fill-side-mask.png"
local barrel_fill_top_mask = "__TS_Pelagos_CF__/graphics/titanium-barreling/barrel-fill-top-mask.png"
-----------------------------------------------------------------------------------------------------------------------

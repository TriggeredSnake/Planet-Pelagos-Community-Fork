...
data:extend({
	{
		...
		icon = "__TS_Pelagos_CF__/graphics/slowdown-rocket.png",
		pictures = {
			layers = {
				{
					size = 64,
					filename = "__TS_Pelagos_CF__/graphics/slowdown-rocket.png",
					scale = 0.5,
					mipmap_count = 4,
				},
			},
...
data:extend({
	{
		type = "ammo",
		name = "poison-rocket",
		icon = "__TS_Pelagos_CF__/graphics/poison-rocket.png",
		pictures = {
			layers = {
				{
					size = 64,
					filename = "__TS_Pelagos_CF__/graphics/poison-rocket.png",
					scale = 0.5,
					mipmap_count = 4,
				},
			},
